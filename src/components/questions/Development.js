            ...
            <div className="container">
                <MuiThemeProvider>
                    <React.Fragment>
                        ...
                        <p style={{display:"inline-block"}}>아동의 발달력 정보를 기입해주세요.</p>
                        <br/>

                        <div>
                            <p style={{display:"inline-block"}}>걷기 (평균 남아 여아 아동 12개월): </p> {' '}
                            <input
                                type="radio" 
                                value ="Slow" 
                                name = "walkingAge"
                            ...
                            <p style={{display:"inline-block"}}>언제 단어를 사용하기 시작했나요? (평균 남아 여아 아동 10-12개월): </p> {' '}
                            <input
                                type="radio" 
                                value ="Slow" 
                                name = "speakingAge"
                            ...
                            <p style={{display:"inline-block"}}>간단한 문장 사용을 언제 시작했나요? (평균 남아 여아 아동 19-24개월): </p> {' '}
                            <input
                                type="radio" 
                                value ="Slow" 
                        ...
                        <p style={{display:"inline-block"}}>아동이 식이/수면/배면 문제를 갖고 있습니까?</p>
                        <br/>
                        <div>
                            <input
                                type="radio" 
                        ...
                        <br />
                        <p style={{display:"inline-block"}}>아동이 현재 대근육 운동, 소근육 운동, 구강 운동 문제를 갖고 있습니까?</p>
                        <br/>
                        <div>
                            <input
                                type="radio" 
