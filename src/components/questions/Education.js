    ...
    render() {
        return (
            <div className="container">
                <MuiThemeProvider>
                    <React.Fragment>
                    <p style={{display:"inline-block"}}>아동이 어린이집/유치원/학교에 다니고 있습니까?</p>
                        <br />
                        <input
                            type="radio" 
                            value ="Yes" 
                        ...
                        <br/>
                        <br />
                        <p style={{display:"inline-block"}}>아동이 언어치료, 놀이치료, 기타 재활치료를 받은 경험이 있습니까?</p>
                        <br/>
                        <input
                            type="radio" 
                            value ="Yes" 
                        ...
                        <p style={{display:"inline-block"}}>교사로부터 아동이 교육기관에서 언어 또는 학업 등과 관련한 문제를 보이고 있음을 보고받은 경험이 있습니까?</p>
                        <br/>
                        <input
                            type="radio" 
                            value ="Yes" 
