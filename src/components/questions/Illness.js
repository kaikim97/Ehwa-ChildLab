    ...
    render() {
        return (
            <div className="container">
                <MuiThemeProvider>
                    <React.Fragment>
                        <p style={{display:"inline-block"}}>아동을 출산하는 과정에서 질병이나 사고가 있었습니까?</p>
                        <br/>
                        <div>
                            <input
                                type="radio" 
                        ...
                        <p style={{display:"inline-block"}}>아동에게 특별한 병력이 있었습니까?</p>
                        <br/>
                        <div>
                            <input
                                type="radio" 
                        ...
                        <p style={{display:"inline-block"}}>아동에게 수술 또는 입원 이력이 있습니까?</p>
                        <br/>
                        <div>
                            <input
                                type="radio" 
                        ...
                        <p style={{display:"inline-block"}}>아동이 현재 투약중인 약물이 있습니까?</p>
                        <br/>
                        <div>
                            <input
                                type="radio" 
